...
import uaswebservice.uasws.exceptions.NonexistentEntityException;
import uaswebservice.uasws.exceptions.PreexistingEntityException;
...
public class DaftarmenuJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("uaswebservice_uasws_jar_0.0.1-SNAPSHOTPU");
